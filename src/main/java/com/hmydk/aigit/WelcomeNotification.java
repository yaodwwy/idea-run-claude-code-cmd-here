...
public class WelcomeNotification implements ProjectActivity {
    ...
    private static final String WELCOME_TITLE_INSTALL = "Welcome to AI Commit Message!";
    private static final String WELCOME_CONTENT_INSTALL = "Thank you for installing AI Commit Message. " +
            "To get started, please configure the plugin in the settings.";
    private static final String WELCOME_TITLE_UPDATE = "AI Commit Message Updated!";
    private static final String WELCOME_CONTENT_UPDATE = "AI Commit Message has been updated to a new version. " +
    ...
    private String getCurrentPluginVersion() {
        IdeaPluginDescriptor descriptor = PluginManagerCore.getPlugin(PluginId.getId("run-claude-code-cmd-anywhere"));
